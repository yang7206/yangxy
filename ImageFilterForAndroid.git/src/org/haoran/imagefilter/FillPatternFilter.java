...
package org.haoran.imagefilter;
...
public class FillPatternFilter implements IImageFilter {
	...
	public FillPatternFilter() {
	}

	public FillPatternFilter(Context ctx, int resourceId) {
		setResource(ctx, resourceId);
	}
	
	public FillPatternFilter(Context ctx, int resourceId,int mixture) {
		setResource(ctx, resourceId);
		setMexture(mixture);
	}

	public void setResource(Context ctx, int resourceId) {
		this.pattern = new Image(BitmapUtils.scaleBitmapRes(ctx,
				resourceId, 20));
	}

	public FillPatternFilter(int mixture) {
		setMexture(mixture);
	}

	public void setMexture(int mixture) {
